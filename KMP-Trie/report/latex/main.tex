...
% Nội dung dùng \captionof{table} trước longtable. Longtable vẫn tự tăng bộ
% đếm khi bắt đầu, nên hoàn lại một đơn vị để danh mục bảng liên tục 1.1,
% 1.2, ... thay vì 1.1, 1.3, ...
\AtBeginEnvironment{longtable}{%
  \addtocounter{table}{-1}%
  \renewcommand*{\theHtable}{longtable.\thechapter.\arabic{table}}%
}
...
\pagenumbering{roman}
\input{frontmatter/cover1}\clearpage
\input{frontmatter/cover2}\clearpage
\input{frontmatter/loi_cam_doan}\clearpage
\input{frontmatter/loi_cam_on}\clearpage
\input{frontmatter/tom_tat}\clearpage
\input{frontmatter/danh_muc_tu_viet_tat}\clearpage
\input{frontmatter/danh_muc_hinh_bang}\clearpage
\tableofcontents\clearpage

\pagenumbering{arabic}
\input{chapters/report_content}\clearpage
...
\appendix
\input{appendices/appendix_resources}
